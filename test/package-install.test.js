...
test("npm tarball installs with a working executable", async () => {
  ...
  const benchmarkApi = await run(
    ...
    [
      "--input-type=module",
      "-e",
      "import { summarizeBenchmarkPairs, runPairedBenchmark, validateExecutionPolicy, validateAdaptiveSession, summarizeComparisonV2Pairs, buildContextPack, validateContextPack, selectExecutionRoute, runOneAttemptRoutedHarness } from '@poketopa/believe-me'; console.log(typeof summarizeBenchmarkPairs, typeof runPairedBenchmark, typeof validateExecutionPolicy, typeof validateAdaptiveSession, typeof summarizeComparisonV2Pairs, typeof buildContextPack, typeof validateContextPack, typeof selectExecutionRoute, typeof runOneAttemptRoutedHarness);",
    ],
    { cwd: installRoot, env: process.env },
  );
