...
export const DETERMINISTIC_EXECUTOR_INPUT_REQUIRED_FIELDS = Object.freeze([
  "schema_version",
  "run_id",
  "manifest_sha256",
...
export const DETERMINISTIC_EXECUTOR_RESULT_REQUIRED_FIELDS = Object.freeze([
  "schema_version",
  "run_id",
  "executor_kind",
  "status",
...
function validateChange(change, seenPaths) {
  assertObject(change, "DeterministicExecutorResult change");
...
export function validateDeterministicExecutorInput(value, options = {}) {
  ...
  assertDeterministicExecutorKind(value.executor_kind);
